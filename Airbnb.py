...
def datafr():
    df= pd.read_csv(r"C:\Users\user\Downloads\Python_DS_Jupyter\MDE89_guvi\Project\Airbnb.csv")
    return df
...
if select == "Home":
    ...
    image1= Image.open(r"C:\Users\user\Desktop\Project env\.venv\images.jpg")
    st.image(image1)
...
if select == "Data Exploration":
    ...
    with tab1:
        ...
        with col1:
            ...
            df_bar= pd.DataFrame(df2.groupby("property_type")[["price","review_scores_rating","number_of_reviews"]].sum())
            df_bar.reset_index(inplace= True)

            fig_bar= px.bar(df_bar, x='property_type', y= "price", title= "PRICE FOR PROPERTY_TYPES",hover_data=["number_of_reviews","review_scores_rating"],color_discrete_sequence=px.colors.sequential.Redor_r, width=600, height=500)
        ...
        with col2:
            ...
            df_do_bar_2= pd.DataFrame(df5.groupby("bed_type")[["bedrooms","beds","accomodates","price"]].sum())
            df_do_bar_2.reset_index(inplace= True)

            fig_do_bar_2 = px.bar(df_do_bar_2, x='bed_type', y=['bedrooms', 'beds', 'accomodates'], 
    ...
    with tab2:
        ...
        def datafr():
            df_a= pd.read_csv(r"C:\Users\user\Downloads\Python_DS_Jupyter\MDE89_guvi\Project\Airbnb.csv")
            return df_a
    ...
    with tab3:
        ...
        df_val_sel_gr= pd.DataFrame(df_val_sel.groupby("accomodates")[["cleaning_fee","bedrooms","beds","extra_people"]].sum())
        df_val_sel_gr.reset_index(inplace= True)

        fig_1= px.bar(df_val_sel_gr, x="accomodates", y= ["cleaning_fee","bedrooms","beds"], title="ACCOMMODATES",
        ...
        fig_3= px.bar(df_val_sel_rt, x="government_area", y= ["host_neighbourhood","cancellation_policy"], title="GOVERNMENT_AREA",
    ...
    with tab4:
        ...
        fig_4 = px.scatter_mapbox(df, lat='latitude', lon='longitude', color='price', size='accomodates',
    ...
    with tab5:
        ...
        fig_top_50_price_1= px.bar(df3_top_50_price, x= "name",  y= "price" ,color= "price",
                                ...
                                hover_data= ["minimum_nights","maximum_nights","accomodates"])
        ...
        fig_top_50_price_2= px.bar(df3_top_50_price, x= "name",  y= "price",color= "price",
                                ...
                                range_color=(0,df3_top_50_price["price"].max()),
                                width=1200, height= 800,
                                hover_data= ["accomodates","bedrooms","beds","bed_type"])
